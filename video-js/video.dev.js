...
vjs.Player.prototype.binddm = function(playerUnit){
	...
	if(typeof CommentManager !== "undefined"){
		vjs.Player.prototype.cmManager = new CommentManager(playerUnit);
		vjs.Player.prototype.cmManager.display = true;
		vjs.Player.prototype.cmManager.init();
		vjs.Player.prototype.cmManager.clear();
		var lastPosition = 0;
		/*if(1){
		...
		video.addEventListener("progress", function(){
			if(lastPosition == video.currentTime){
				...
				vjs.Player.prototype.cmManager.stopTimer();
			}else
		...
		video.addEventListener("timeupdate", function(){
			if(vjs.Player.prototype.cmManager.display === false) return;
			if(video.hasStalled){
				vjs.Player.prototype.cmManager.startTimer();
				video.hasStalled = false;
			}
			vjs.Player.prototype.cmManager.time(Math.floor(video.currentTime * 1000));
		});
		...
		video.addEventListener("ratechange", function(){
			if(vjs.Player.prototype.cmManager.def.globalScale != null){
				if(video.playbackRate !== 0){
					vjs.Player.prototype.cmManager.def.globalScale = (1 / video.playbackRate);
					vjs.Player.prototype.cmManager.rescale();
				}
			}
		});
